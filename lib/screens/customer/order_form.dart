              ...
              for (final w in windows)
                Padding(
                  ...
                  child: ChoiceChip(
                    ...
                    labelStyle: TextStyle(fontWeight: FontWeight.w600, color: w.id == selectedId ? scheme.onPrimaryContainer : null),
          ...
          for (final n in names)
            Padding(
              ...
              child: ChoiceChip(
                ...
                labelStyle: TextStyle(fontWeight: FontWeight.w600, color: selected == n ? Theme.of(context).colorScheme.onPrimaryContainer : null),
                shape: const StadiumBorder(),
