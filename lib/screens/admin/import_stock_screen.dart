    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: has ? AppColors.brandWash : scheme.surfaceContainerHighest,
          borderRadius: BorderRadius.circular(AppRadius.lg),
        ...
        child: Column(
          children: [
            ...
            Text(has ? fileName! : 'Choose a file to upload', style: t.titleMedium),
            const SizedBox(height: 4),
            Text(has ? 'Tap to choose a different file' : '.xlsx or .csv', style: t.bodySmall),
          ],
        ),
      ),
    );
